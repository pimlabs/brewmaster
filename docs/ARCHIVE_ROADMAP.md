# ROADMAP — brewmaster (v1 archive)

> **Archived 2026-06-11.** v1 (M0-M5, v0.1.0-v0.6.0) is complete and frozen.
> Kept as a historical record and for the frozen function contracts
> referenced by `tests/`. For current status and v2 planning, see
> [`../ROADMAP.md`](../ROADMAP.md).

---

> **For AI coding assistants (Claude Code and others):**
> This document is the single source of truth for brewmaster's v1 development
> history. Read this file for milestone context, frozen function signatures,
> and design rationale — but do not treat it as an open task list.
