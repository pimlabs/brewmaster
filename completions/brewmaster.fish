...
complete -c brewmaster -n '__fish_seen_subcommand_from upgrade; or __fish_brewmaster_no_subcommand' -f -l level -a 'patch minor major' -d 'Bump level'
...
complete -c brewmaster -n '__fish_seen_subcommand_from upgrade; or __fish_brewmaster_no_subcommand' -f -l profile -a '(__fish_brewmaster_profiles)' -d 'Filter/level from a named profile'
...
complete -c brewmaster -n '__fish_seen_subcommand_from upgrade; or __fish_brewmaster_no_subcommand' -f -l risk-threshold -d 'High-risk cutoff (default 7)'
...
complete -c brewmaster -n '__fish_seen_subcommand_from upgrade; or __fish_brewmaster_no_subcommand' -f -a '(__fish_brewmaster_packages)'
...
complete -c brewmaster -n '__fish_seen_subcommand_from profile; and __fish_seen_subcommand_from edit' -f -a '(__fish_brewmaster_profiles)'
complete -c brewmaster -n '__fish_seen_subcommand_from profile; and __fish_seen_subcommand_from diff' -f -a '(__fish_brewmaster_profiles)'
...
complete -c brewmaster -n '__fish_seen_subcommand_from completion; and not __fish_seen_subcommand_from bash zsh fish' -f -a 'bash zsh fish'
