...
TBD — where the command may appear on the command line: `bin/brewmaster`
takes the first non-flag argument that names a command, wherever it
sits, so flags may precede it; the generated completions offer commands
in the same places.
